...
/**
 * Programa que demana una nota final entre 0 i 10 i retorna les notes introduïdes separades per comes en ordre, també dona l'opció de treure una nota d'una posició seleccionada i calcula altre cop la mitja, pitjor i millor **/
import java.util.*;
public class P10_Nota7{
